...
$today = date("d-m-Y");
  ...
  $invoice->setType("Rapport quotidien des ventes");
  $invoice->setReference("Rep-".$today);
  //$invoice->setDate();
 // $invoice->setTime();
 // $invoice->setDue();

  $invoice->setFrom(array("Seller Name"));
 ...
 // $invoice->addTitle("Important Notice");
  ...
  /* Render */
  $invoice->render('DailyReport'.$today.'.pdf','D'); /* I => Display on browser, D => Force Download, F => local path save, S => return document path */
?>